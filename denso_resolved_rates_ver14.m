...
q_ini=[5.96*pi/180;24.29*pi/180;88.62*pi/180;10.12*pi/180;37.77*pi/180;12.69*pi/180;0;0];
griper_c=0;
q_c=q_ini;
...
%     end
    ...
    x_dot= [v;w];
    %%%%%%%%%%%%%%%%%%%%%%%%
%     [U_rcmp,S_rcmp,V_rcmp] = svd(J_rcm_p);  
%     if S_rcmp(2,2)<=0.1
%         J_rcm_p_plus=transpose(J_rcm_p)/(J_rcm_p*transpose(J_rcm_p)+lamda*eye(3));
%         disp(j)
%         disp('rcm singular')
%         q_c
%     else
...
%     end
 %%%%%%%%%%%%%%%%%%%%%%%%%%% 
%  Weig_vec=[0;0;0;(q_c(4)-pi/10)*(q_c(4)-pi/10);0;q_c(6)*q_c(6);0;0];
